...
public:
	...
	void Simulate(sf::RenderTarget* window, float cameraZ, float viewingDistance, std::vector<WorldSpaceParticle>* _input);

	void Render(sf::RenderTarget* window, float cameraZ, float viewingDistance);
